...
import { Stack as IStack } from '../interfaces/use'
import Head from '@/components/header'
import Container from '@/components/container'
import { useState, useMemo } from 'react'

export default function Stack({ data, categories }) {
    ...
    <div>
      ...
      <Container className="px-4">
        <div className=" justify-start max-w-screen-sm">
          <div className="grid grid-cols-1 md:grid-cols-2 justify-between items-center my-10 flex-wrap sm:flex-nowrap">
            <h1 className="col-start-1 text-black font-semibold text-4xl">
              My Toolbox
            </h1>
            <div className="md:col-start-13 bg-gray-100 px-4 py-2 mt-5 sm:mt-0 rounded-md">
              <select
          ...
          <div className="space-y-2">
            {filteredStack?.map((stack: IStack) => (
              <a
                href={stack.link}
